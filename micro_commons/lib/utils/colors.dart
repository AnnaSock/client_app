...
// into color
const Color kTextLargeColor = Color(0xFF4A4B71);
...
const homeTab = Color(0xFFDBDFFF);
final lightPrimaryColor = Color.fromRGBO(40, 44, 93, 0.01);
const secondaryColor = Color(0xFFA81735);
const bodyColor = Color(0xFF344054);
final backgroundPage = Color.fromRGBO(255, 255, 255, 0.2);
const errColor = Color(0xFFF04438);
const pendingColor = Color(0xFFDC6803);
const disabledColor = Color(0xFF667085);
const inputColor = Color(0xFF5A5454);
const hintColor = Color(0xFFB7BFCF);
const headingColor = Color(0xFF101828);
const bgCircleColor = Color(0xFFE7E9FF);
const moonColor = Color(0xffbbc0fb);
const lightBlueColor = Color(0xfff3f4ff);
const defaultColor = Color(0xEFFCFCFC);
const validColor = Color(0xEF38BF52);
const Color debitColor = Color(0xFFE8122B);
...
const contactPurple = Color(0xFF9377F0);
const contactBlue = Color(0xFF4884E7);
const contactGray = Color(0xFF9499D1);
const contactGreen = Color(0xFF39BE76);
const contactName = Color(0xFF344054);
const contactNumber = Color(0xFFA5B5CF);
...
const borderButtonColor = Color(0xFFD0D5DD);
const textButtonColor = Color(0xFF1B1F22);
...
const Color yellowWarning = const Color(0xFFFEF0C7);
const Color lightWarning = const Color(0xFFFFFAEB);
const Color redError = const Color(0xFFFADFDF);
const Color lightError = const Color(0xFFFCEDED);

const backgroundBottomSheetColor = Color(0xFFF5F6FF);
const borderBottomSheetColor = Color(0xFFBBC0FB);

const textBottomSheetColor = Color(0xFF565F82);
const transactionBackgroundEchecColor = Color(0xFFF7F2F2);

const backgroundBottomSheetErrorColor = Color(0xFFFCEDED);
const backgroundBottomSheetErrorIconColor = Color(0xFFC52B2B);

const iconCloseColor = Color(0xFFABB1CC);
